...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="88" y="470" font-family="Helvetica, Arial, sans-serif" font-size="28" fill="#6B4148">A student-led nonprofit that teaches elementary and</text>
  <text x="88" y="510" font-family="Helvetica, Arial, sans-serif" font-size="28" fill="#6B4148">middle school students about diseases and disorders.</text>
</svg>`;
