# Live-site content inventory, projectpatho.org

> Captured 2026-07-07 from https://www.projectpatho.org (Google Sites).
> This is the **frozen source of truth** for goal **G1 (content parity)**. The
> rebuild must reproduce every item below. The G1 verifier diffs the new site
> against this file, nothing here may be dropped.

---

## 0. Site identity

- **Name:** Project Patho (ProjectPatho)
- **Tagline:** "Student-run Nonprofit Organization"
- **Mission (verbatim):** "ProjectPatho is a student-led nonprofit that educates
  elementary and middle school students about diseases and disorders through
  interactive resources. We spread awareness about rare or commonly misunderstood
  conditions to reduce stigma, inspire empathy, and spark interest in the science
  of pathology from an early age."
- **Secondary mission note:** Teaches medical and biological concepts via social
  media, making complex topics accessible and engaging.
- **Home CTA (verbatim):** "Check out our upcoming event information below or our
  infographics for students aged 7-11!"
- **Fiscal sponsor note (verbatim):** "Fiscally Sponsored by Brushstrokes for
  Biodiversity a 501(c)(3) nonprofit organization"

## 1. Navigation (live IA, to be REPLACED with a new flow, but every destination must survive)

- Home
- Meet The Team
- Resources → Info Posters → {Bipolar Disorder, Cystic Fibrosis, Epilepsy,
  Fragile X Syndrome, Osteogenesis Imperfecta, Sickle Cell Anemia}
- Events → {Upcoming Events, Past Events, Cards for Hospitalized Kids}
- Join Us → {Join Us, Contact Us}
- Podcast
- BfB (external → Brushstrokes for Biodiversity)
...
1. **Jolina Jian, Co-President.** "Jolina Jian is a rising junior at Canyon Crest
   Academy. She is a member of her school's iGEM team, serves on the GSDSEF Student
   Leadership Board, and enjoys competing in science fairs and other STEM
   competitions. Outside of academics, Jolina enjoys golfing and spending time with
   her two pet chinchillas."
2. **Aarini Parikh, Co-President.** "Aarini Parikh is a rising junior at Del Norte
   High School with a strong passion for science and healthcare. She serves as the
   Secretary of Del Norte's HOSA chapter and has competed in the Forensics event at
   the HOSA State Leadership Conference. Beyond academics, she enjoys playing water
   polo, swimming, and reading. Aarini is eager to explore the many facets of
   medicine and aspires to pursue a career in pediatrics, endocrinology, or
   anesthesiology."
3. **Prisha Shrivastava, VP of Operations.** "Prisha Shrivastava is a rising junior
   at Del Norte High School. She is a strong advocate, highlighting student research
   and leading initiatives. In addition to her academic pursuits, Prisha is actively
   involved in extracurricular activities including water polo, drums, and dance. She
   hopes to pursue neuropsychology or diabetes research."
4. **Ridah Mannat, VP of Logistics.** "Ridah Mannat is a rising junior at Del Norte
   High School. As a member of HOSA and Vice President of Del Norte High School's
   chapter of Child Rights and You, she is passionate about advocating for children
   with medical conditions and supporting health-related outreach initiatives. In the
   future, she hopes to become a physician in neonatology, combining patient care
   with research to advance treatments for newborns with congenital and genetic
   conditions."
5. **Michelle Yu, Treasurer.** "Michelle Yu is a rising junior at Del Norte High
   School. She loves all aspects of science, biology in particular, and she's
   participated in Science Olympiad for 3 years now."
6. **Aditi Jain, Secretary.** "Aditi Jain is a rising junior at Del Norte High
   School and has been passionate about biology and medicine for several years. She
   loved taking AP Biology and has been fundraising for the Cystic Fibrosis
   foundation, eager to find a cure someday!"

## 4. Info Posters (6 topics; each is a team-created infographic + a quiz)

Poster artwork lives on Google Drive on the live site (team's original work). In the
...
4. 1/22, **Making Care Packages**, Del Norte Club Meeting
5. 12/20, **Neurology Workshop**, 4s Ranch Library
6. 10/25, **Psychology Workshop**, 4s Ranch Library
7. 9/27, **First Aid Kit Workshop (25+ students)**, 4s Ranch Library
8. 9/17, **Club Rush**, Del Norte High School
9. 8/8, **Immune System Workshop**, 4s Ranch Library
...
- Specially drawn **animal artwork** goes into small gifts for local hospital
  patients; community members write **uplifting messages on the back**.
- Volunteers recruited at **Poway Farmer's Market** and library events.
- "Combined event by BfB + Project Patho" (Brushstrokes for Biodiversity).
- References a "Del Norte Event."

## 6. Podcast, "PathoTalks" (10 episodes + trailer)
...
- **Join Us:** "Join Us!" heading + link to Google Form "ProjectPatho Interest Form":
...
## 8. Footer / partners / socials

- **Partner / fiscal sponsor:** Brushstrokes for Biodiversity (501c3) ,
  https://brushstrokesforbiodiversity.org/
- **Instagram:** projectpatho (canonical, per Contact page).
  ⚠️ DISCREPANCY: the live footer Instagram icon links to an unrelated account
  ("shellysssweets"). Treated as a live-site bug, rebuild uses the canonical
  https://www.instagram.com/projectpatho/. **Team to confirm.**
